    ...
    <div className="min-h-screen flex bg-gray-800">
      ...
      <div className="flex-grow flex mb-5 mt-20">
        ...
        <div className="flex-1 flex justify-center items-center">
          <div className="bg-white text-gray-700 p-4 border border-gray-300 rounded-lg shadow-lg" style={{ width: '600px' }}> {/* Largura customizada */}
            
            <h2 className="text-center text-2xl font-semibold mb-5">Criar Conta</h2>
            
            <form onSubmit={handleSubmit}>
            <InputField label="Nome" type="text" placeholder="Nome completo" />

            <div className="flex justify-between">
              <InputField label="Documento" type="text" placeholder="CPF" className="mr-2 flex-1" />
              <InputField label="Telefone" type="tel" placeholder="Telefone com DDD" className="flex-1" />
            </div>

            <InputField label="Email" type="email" placeholder="Email" required />

            <div className="flex justify-between">
              <InputField label="Senha" type="password" placeholder="Senha" required className="mr-2 flex-1" />
              <InputField label="Confirmar Senha" type="password" placeholder="Confirmar senha" required className="flex-1" />
            </div>
